...
<script src="https://aydavidgithere.github.io/res/aygraph2.js">
 ...
 function run(){
    ...
    function eachTr( startX , startY , iceWid , iceHei ){
        iceWidF = iceWid;
        b.beginPath();
        b.moveTo(startX, startY)
        b.lineTo(startX+iceWid/2, startY-iceHei);
        b.lineTo(startX+iceWid/1.0, startY-iceHei/iceHei);
        b.fillStyle = "steelblue"; b.fill();
        b.closePath();
        ...
        b.beginPath();
        b.moveTo(startX, startY)
        b.lineTo(startX+iceWidF/2, startY-iceHei);
        b.lineTo(startX+iceWid/1.5, startY-iceHei/1.5);
        b.lineTo(startX+iceWid/2.3, startY-iceHei/2);
        b.lineTo(startX+iceWid/1.3, startY-iceHei/5);
        b.lineTo(startX+iceWid/2.1, startY-iceHei/7);
        b.lineTo(startX+iceWid/1.0, startY-iceHei/iceHei);
        b.fillStyle =
        ["rgb(189, 222, 236)", "rgb(174,219, 240)","rgb(203, 214, 230)"][i]; 
        b.fill();
        b.closePath();
        iceWid /= (1.3);//+Math.random()*10);
        i++;
        }
    }
...
var backG_ = {
    ...
    drawIceMount: function(){
         for(let i=0; 300>i; i++){
            eachTr(this.x+i*this.xWid_ice, mH-this.y, this.xWid_ice, this.yWid_ice);
         }
    },
    motion: function(){
        this.x = this.x-2.5
...
txt(mW/20+"pt$# font6",""+Math.round(gameI.distance)+"m",mW/2,mH/12, 0, 1000);
if(hero.meet){ 

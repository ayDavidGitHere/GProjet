...
var lastCrashId = " ";
var randColor = 
["darkblue", "darkred", "darkred"][Math.floor(Math.random()*3)];     
...
function addGeos(){
    ...
    */
    ...
    //texture loader
    var textureUrl = "http://localhost:8080/mein3/img/"+["sand.jpg", "rock.jpg", "rock.jpg"][Math.floor(Math.random()*3)]; 
    ...
    //texture loader
    var textureUrl = "http://localhost:8080/mein3/img/rock.jpg"; 
    var texture = THREE.ImageUtils.loadTexture(textureUrl);
    // 加入控制的cube
